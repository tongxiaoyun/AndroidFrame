 ...
 * ================================================
 */
public class DocumentHandleXLS extends BaseDocumentHandle {

    private static DocumentHandleXLS instance;
    private File myFile;
    private String htmlPath;
    private FileOutputStream output;

    private DocumentHandleXLS() {
    }

    public static DocumentHandleXLS getInstance() {
        if (instance == null) {
            instance = new DocumentHandleXLS();
        }
        return instance;
    }
